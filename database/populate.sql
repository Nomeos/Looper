...
# quiz
INSERT INTO `looper`.`quiz` (`title`, `is_public`, `quiz_state_id`) VALUES ('Building form', '0', '1');
INSERT INTO `looper`.`quiz` (`title`, `is_public`, `quiz_state_id`) VALUES ('Answering form', '1', '2');
INSERT INTO `looper`.`quiz` (`title`, `is_public`, `quiz_state_id`) VALUES ('Closed', '1', '3');
